...
const COLOR_WHITH = Colors.white;
...
const TextTheme TEXT_THEME_DEFAULT  =TextTheme(
  ...
  bodyText2: TextStyle(color:COLOR_GREY,fontWeight:FontWeight.w500,fontSize: 14,height: 1.5),

  subtitle1: TextStyle(color:COLOR_BLACK,fontWeight:FontWeight.w400,fontSize: 12),
  subtitle2: TextStyle(color:COLOR_GREY,fontWeight:FontWeight.w400,fontSize: 12),
...
const TextTheme TEXT_THEME_SMALL =TextTheme(
  ...
  bodyText2:TextStyle(color:COLOR_GREY,fontWeight:FontWeight.w500,fontSize: 12,height: 1.5),
